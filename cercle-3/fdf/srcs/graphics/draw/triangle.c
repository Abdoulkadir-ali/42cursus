...
static void	draw_horizontal_scanline_z(t_graphics *g, int x1, int x2, int y,
...
void	draw_filled_triangle(t_graphics *g, t_point p1, t_point p2, t_point p3)
{
	int	y;
	int	x1;
	int	x2;
	...
	while (y <= y_max)
	{
		...
		draw_horizontal_scanline_z(g, x1, x2, y, z1, z2, c1, c2);
		y++;
	}
}
