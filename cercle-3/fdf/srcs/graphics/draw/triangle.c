...
static void	rasterize_flat_bottom(t_graphics *g, t_point top, t_point b1,
		t_point b2)
{
	int				y_start;
	int				y_end;
...
static void	rasterize_flat_top(t_graphics *g, t_point t1, t_point t2,
		t_point bot)
{
	int				y_start;
	int				y_end;
