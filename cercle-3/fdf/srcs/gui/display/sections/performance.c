...
/*   Updated: 2025/11/22 14:27:51 by abdoali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_performance_display_layout(t_layout *l, t_gui *gui)
{
	...
	gui_layout_key_value(l, "Z-Divisor (X):",
		gui->camera->use_z_divisor ? "ON" : "OFF");
	gui_layout_key_value(l, "Invert Move (I):",
		gui->camera->invert_movement ? "Camera" : "Object");
	gui_layout_key_value(l, "Depth Cull (V):",
	...
	else
	{
		...
		gui_layout_key_value(l, "Fill Tri (G):",
