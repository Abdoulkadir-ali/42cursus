...
/*   Updated: 2026/03/10 03:37:50 by abdoali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Add another 3D integer vector in place.
...
/**
 * @brief Subtract another 3D integer vector in place.
 * @param self Vector to modify.
...
/**
 * @brief Multiply by another 3D integer vector in place.
 * @param self Vector to modify.
...
/**
 * @brief Divide by another 3D integer vector in place.
 * @param self Vector to modify.
...
/**
 * @brief Multiply all components by one integer scalar.
 * @param self Vector to modify.
