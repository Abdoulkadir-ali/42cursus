...
/*                                                +#+#+#+#+#+
	+#+           */
/*   Created: 2026/01/08 07:12:01 by abdoali           #+#    #+#             */
/*   Updated: 2026/01/08 07:12:01 by abdoali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	ft_handle_flags(const char *str, size_t *i, va_list args,
		int *error);
size_t	ft_handle_nbr(t_flags flags, va_list args,
		const char *base);
...
void	ft_build_flags(t_flags *f, const char *str, size_t *i, va_list args);
