...
/**
 * @brief Initializes the flags structure.
...
/**
 * @brief Executes public ft_handle_percent utility.
 * @note Public library exported function.
 */
...
/**
 * @brief Executes public ft_handle_format utility.
 * @note Public library exported function.
 */
...
/**
 * @brief Executes public ft_process_format utility.
 * @note Public library exported function.
 */
