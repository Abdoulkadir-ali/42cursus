...
void				glb_handle_indices_short(t_mesh_asset *mesh,
					t_json_value *json, char *bin, int idx);
void				glb_fill_attributes(t_mesh_asset *mesh, t_json_value *json,
					char *bin, int ids[6]);
...
t_animation			*glb_extract_animations(t_json_value *json, char *bin,
						int *out_count);
void				glb_load_skeleton_impl(t_mesh_asset *mesh, t_json_value *json,
						char *bin, int idx);
