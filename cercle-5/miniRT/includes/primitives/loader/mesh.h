...
void	init_mesh(t_mesh_asset *mesh, const char *name);
void	init_metadata_mesh_asset(t_mesh_asset_metadata *meta, const char *name,
			const char *path);
void	init_metadata_mesh_instance(t_mesh_instance_metadata *meta, t_mesh *instance,
			const char *name);
