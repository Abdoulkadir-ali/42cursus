...
/*   Updated: 2026/04/09 17:31:20 by abdoali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	fill_ref_a(t_scene *s, t_bvh_ref ref, t_ref_data *d)
{
	...
	{
		d->shape = init_gjk_shape(&s->boxes[ref.index],
...
static bool	fill_ref_b(t_scene *s, t_bvh_ref ref, t_ref_data *d)
{
	...
	{
		d->shape = init_gjk_shape(&s->rects[ref.index],
	...
	{
		d->shape = init_gjk_shape(&s->tris[ref.index],
