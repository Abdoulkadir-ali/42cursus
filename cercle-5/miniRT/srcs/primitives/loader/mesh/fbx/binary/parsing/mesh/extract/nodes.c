 ...
 */
static void
p_arr(t_fbx *fbx, void **dst, uint32_t *cnt, int sz)
{
 ...
 */
static void
p_data(t_fbx *f, t_fbx_bin_node *n)
{
 ...
 */
static void
p_node(t_fbx *f, uint64_t end, int d)
{
t_fbx_bin_node	n;

if (d > 20)
{
ft_printf("WARNING: FBX max node depth reached\n");
return ;
}
 ...
 */
void
fbx_parse_nodes(t_fbx *f, uint64_t end)
{
p_node(f, end, 0);
}
