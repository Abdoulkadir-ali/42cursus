...
/*   Updated: 2026/03/08 21:02:01 by abdoali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** Written from scratch for miniRT — not derived from any copyrighted font.
*/
...
/*
** Draw a single glyph from the bitmap font into disp_img.
** x, y: top-left corner of the 8x8 cell.
** Only draws set bits; background pixels are transparent.
*/
static void	draw_char(t_gui *gui, unsigned char c, int x, int y,
				unsigned int color)
{
