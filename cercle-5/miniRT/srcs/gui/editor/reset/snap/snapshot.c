...
static voidsnap_prim_soa(t_primitive_array *d, const t_primitive_array *s)
{
size_tn;
...
static voidsnap_tri_soa(t_tri_array *d, const t_tri_array *s)
{
size_tn;
inti;
...
voidscene_snapshot(t_scene_snap *snap, t_gui *gui)
{
t_scene*sc;
...
voidscene_snap_free(t_scene_snap *snap)
{
t_primitive_array*p;
t_tri_array*t;
inti;
