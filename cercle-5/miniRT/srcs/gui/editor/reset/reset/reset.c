...
/*   Updated: 2026/03/28 14:45:12 by abdoali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	restore_prim_soa(t_primitive_array *d, const t_primitive_array *s)
{
	size_t	n;
...
static void	restore_tri_soa(t_tri_array *d, const t_tri_array *s)
{
	size_t	n;
	int		i;
